...
int main(void) {
	...
	FILE* fp1 = fopen("220214_03_beneficial.txt", "w");
	FILE* fp2 = fopen("220214_03_neutral.txt", "w");
	FILE* fp3 = fopen("220214_03_N.txt", "w");
	...
	for (int i = 0; i < rounds; ++i) {
		...
		for (int j = 1; j < num_gen; ++j) {
			int** new_gen = (int **) malloc(sizeof(int *) * num_ind * 2);
			for (int i = 0; i < num_ind * 2; ++i) {
